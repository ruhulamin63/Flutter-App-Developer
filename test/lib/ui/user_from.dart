...
import 'package:test_project/widgets/customButton.dart';
...
class _UserFormState extends State<UserForm> {
  ...
  sendUserDataToDB()async{
    ...
    }).then((value) => Fluttertoast.showToast(msg: "User info added into database")).catchError((error)=>Fluttertoast.showToast(msg: "Something wrong"));
  }
